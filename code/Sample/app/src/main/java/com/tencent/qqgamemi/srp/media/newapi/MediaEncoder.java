...
//		mMediaCodec.signalEndOfInputStream();	// API >= 18
     ...
     *
     * @param buffer
     * @param length&#x9286;&#xfffd;length of byte array, zero means EOS.
...
//        	throw new NullPointerException("muxer is unexpectedly null");
        ...
        while (mIsCapturing) {
            ...
            if (DEBUG)
                Log.d(TAG, "class:" + this.getClass().toString() + " drain encoderStatus:" + encoderStatus);
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                if (mBufferInfo.size != 0) {
                    ...
                    if (!mRequestPause) {
                        ...
                        if (DEBUG) {
                            Log.d(TAG, "MediaCodec:" + mMediaCodec.toString() + " this Class:" + this.getClass() + " mTrackIndex:" + mTrackIndex + "mBufferInfo offsize: " + mBufferInfo.offset + " size:" + mBufferInfo.size);
                        }
